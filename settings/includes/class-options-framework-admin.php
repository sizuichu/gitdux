	    ...
	    <div id="optionsframework-metabox" class="metabox-holder">
		    <div id="optionsframework" class="postbox">
				...
				<div id="optionsframework-submit">
                    ...
                    <a href="http://t.cn/R1HtC2y" target="_blank" class="reset-button button-primary" style="float: right;">更快节省68%</a> 
<a href="http://t.cn/R1HyQnJ" target="_blank" class="reset-button button-primary" style="float: right;">科学上网，访问Google等服务</a> 
					<div class="clear"></div>
				</div>
				</form>
			</div> <!-- / #container -->
